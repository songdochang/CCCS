    ...
    public class UserAdminController : Controller
    {
        ...
        public async Task<ActionResult> Create(CreateModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        UserID = user.Id,
                        EmployeeID = model.EmployeeID.ToUpper().Replace("E", ""),
                        FullName = model.Name,
        ...
        public async Task<ActionResult> Delete(string id)
        {
            ...
            if (user != null)
            {
                ...
                {
                    return View("ShowResult", result.Errors);
                }
            }
            else
            {
                TempData["Message"] = "Error: User Not Found";
                return View("ShowResult", new string[] { "User Not Found" });
            }
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Edit(string id, string email, string password, string phoneNumber)
        {
            ApplicationUser user = await UserManager.FindByIdAsync(id);
            if (user != null)
            {
